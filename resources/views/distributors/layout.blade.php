                ...
                <div class="container-fluid">
                  ...
                  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <div class="navbar-nav">
                      <a class="nav-link active" aria-current="page" href="{{ route('mereks.index') }}">Home</a>
                      <a class="nav-link" href="{{ route('mereks.index') }}">Merek</a>
                      <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                        <div class="navbar-nav">
                          <a class="nav-link active" aria-current="page" href="{{ route('distributors.index') }}"></a>
                          <a class="nav-link" href="{{ route('distributors.index') }}">Distributor</a>
                          <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                          <div class="navbar-nav">
                            <a class="nav-link active" aria-current="page" href="{{ route('barangs.index') }}"></a>
                            <a class="nav-link" href="{{ route('barangs.index') }}">Barang</a>
                            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                                <div class="navbar-nav">
                                    <a class="nav-link active" aria-current="page" href="{{ route('transaksis.index') }}"></a>
